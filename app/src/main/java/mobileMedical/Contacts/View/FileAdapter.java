...
public class FileAdapter extends BaseAdapter {
	...
	public FileAdapter(Context context, List<String> it, List<String> pa) {
		...
		mIcon1 = BitmapFactory.decodeResource(context.getResources(),
				R.drawable.contact_back01);
		mIcon2 = BitmapFactory.decodeResource(context.getResources(),
				R.drawable.contact_back02);
		mIcon3 = BitmapFactory.decodeResource(context.getResources(),
				R.drawable.contact_folder);
		mIcon4 = BitmapFactory.decodeResource(context.getResources(),
				R.drawable.contact_doc);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.contact_vlist_files , null);
			/* 初始化holder的text与icon */
