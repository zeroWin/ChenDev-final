...
public class BloodOxygenHistory extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.blood_oxygen_st_history);
		dbManager = new DBManager(BloodOxygenHistory.this);
		initView();
...
//				startActivity(startMeasIntent);
	...
	private void initView() {
		patientHistoryInfolv = (ListView) this
				.findViewById(R.id.BloodOxygenHistory);
	...
	private void initPatientHistoryInfoTable() {
		...
		Cursor cursor = boDbHelper.getOneSpecItem(MessageInfo.SENSORTYPE_BLOODOXYGENMETER);
