...
public class BloodOxygenStatistics extends TabActivity {
	boDb btDbHelper = new boDb(this, "bloodox.db", null, 1);
	private TabHost tabHost = null;
	private final boolean D = true;
	private final String TAG = "BloodOxygenStatitics";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.blood_oxygen_st);
		context=this;
		initView();
		tabHost = getTabHost();
		TabSpec BloodOxygenHistory = tabHost.newTabSpec("BloodOxygenHistory");
		// BloodOxSpec.setIndicator(view);
		BloodOxygenHistory.setIndicator("历史数据");
		Intent BloodOxygenHistoryIntent = new Intent(this, BloodOxygenHistory.class);
		BloodOxygenHistory.setContent(BloodOxygenHistoryIntent);

		tabHost.addTab(BloodOxygenHistory);

		tabHost.addTab(tabHost.newTabSpec("BloodOxygenLine").setIndicator("波形图")
				.setContent(new Intent(this, BloodOxygenStLine.class)));
