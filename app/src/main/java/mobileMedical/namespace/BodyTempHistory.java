...
public class BodyTempHistory extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.body_temp_st_history);
		dbManager = new DBManager(BodyTempHistory.this);
		initView();
		...
		patientHistoryInfolv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				startMeasIntent.setClass(BodyTempHistory.this, MobileMedicalActivity.class);
	...
	private void initView() {
		patientHistoryInfolv = (ListView) this
				.findViewById(R.id.BodyTempHistory);
	...
	private void initPatientHistoryInfoTable() {
		...
		Cursor cursor = boDbHelper.getTmpItem();
