...
public class BloodPressureHistory extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.blood_pressure_st_history);
		dbManager = new DBManager(BloodPressureHistory.this);
		initView();
...
//				startActivity(startMeasIntent);
	...
	private void initView() {
		patientHistoryInfolv = (ListView) this
				.findViewById(R.id.BloodPressureHistory);
	...
	private void initPatientHistoryInfoTable() {
		...
		Cursor cursor = boDbHelper.getOneSpecItem(MessageInfo.SENSORTYPE_BLOODPRESSUREMETER);
