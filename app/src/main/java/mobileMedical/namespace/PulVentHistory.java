...
public class PulVentHistory extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pulvent_st_history);
		dbManager = new DBManager(PulVentHistory.this);
		initView();
		...
		patientHistoryInfolv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				String time = patientHistoryInfoList.get(arg2).get("time")
						.toString();
				time = MemberManage.turnCNTimeToDBTime(time);
				Intent startMeasIntent = new Intent();
				startMeasIntent.setClass(PulVentHistory.this,
						MobileMedicalActivity.class);
				startMeasIntent.putExtra("tabindex", 4);
				startMeasIntent.putExtra("time", time);
	...
	private void initView() {
		patientHistoryInfolv = (ListView) this
				.findViewById(R.id.PulVentHistory);
	...
	private void initPatientHistoryInfoTable() {
		...
		Cursor cursor = boDbHelper
				.getOneSpecItem(MessageInfo.SENSORTYPE_PULMONARYVENTILATION);
