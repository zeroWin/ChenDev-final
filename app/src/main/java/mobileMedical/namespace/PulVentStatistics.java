...
public class PulVentStatistics extends TabActivity {
	boDb btDbHelper = new boDb(this, "bloodox.db", null, 1);
	private TabHost tabHost = null;
	private final boolean D = true;
	private final String TAG = "PulVentStatitics";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pulvent_st);
		context=this;
		initView();
		tabHost = getTabHost();
		TabSpec PulVentHistory = tabHost.newTabSpec("PulVentHistory");
		// BloodOxSpec.setIndicator(view);
		PulVentHistory.setIndicator("历史数据");
		Intent PulVentHistoryIntent = new Intent(this, PulVentHistory.class);
		PulVentHistory.setContent(PulVentHistoryIntent);

		tabHost.addTab(PulVentHistory);

		tabHost.addTab(tabHost.newTabSpec("PulVentLine").setIndicator("波形图")
				.setContent(new Intent(this, PulVentStLine.class)));
